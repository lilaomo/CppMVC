#include "controller/permission_ctrller.h"

lilaomo::permission_ctrller::permission_ctrller() : common_ctrller<permission_ctrller, permission_service_t>("permission_ctrller"sv) {

}

lilaomo::permission_ctrller::~permission_ctrller() {

}



void lilaomo::permission_ctrller::login(cinatra::request& req, cinatra::response& res) {
...
void lilaomo::permission_ctrller::logout(cinatra::request& req, cinatra::response& res) {
...
void lilaomo::permission_ctrller::update_user(cinatra::request& req, cinatra::response& res) {
	auto&& [ret, req_json] = pre_handle_json(req, res);
	if (!ret)
		return;
...
void lilaomo::permission_ctrller::get_all_user(cinatra::request& req, cinatra::response& res) {
	auto&& [ret, req_json] = pre_handle_json(req, res);
	if (!ret)
		return;
...
void lilaomo::permission_ctrller::add_user(cinatra::request & req, cinatra::response & res) {
	auto&& [ret, req_json] = pre_handle_json(req, res);
	if (!ret)
		return;
...
void lilaomo::permission_ctrller::delete_user(cinatra::request& req, cinatra::response& res) {
	auto&& [ret, req_json] = pre_handle_json(req, res);
	if (!ret)
		return;
